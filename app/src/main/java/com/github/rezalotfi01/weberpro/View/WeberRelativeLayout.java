...
public class WeberRelativeLayout extends RelativeLayout implements AlbumController {
    ...
    public WeberRelativeLayout(Context context) {
        this(context, null);
    }

    public WeberRelativeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WeberRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
