    ...
    private void showEditDialog() {
        ...
        editText.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                if (domain.isEmpty()) {
                    WeberToast.Companion.show(getContext(), R.string.toast_input_empty);
                    return true;
                } else if (!BrowserUtils.isURL(domain)) {
                    WeberToast.Companion.show(getContext(), R.string.toast_invalid_domain);
                    return true;
                } else {
                    sp.edit().putString(getContext().getString(R.string.sp_search_engine), "5").apply();
                    sp.edit().putString(getContext().getString(R.string.sp_search_engine_custom), domain).apply();
